//case break for chests, coins, thieves; rules, gamestate, ending screen 
...
var bg, bcg, testsprite, theif, randx, coin1, score;
...
function draw() {
  ...
  fill("white")
  textSize(20)
  text("score: "+score, testsprite.x - 35, testsprite.y - 50)
...
function scoreCount() {
  ...
  if(testsprite.x === coin1.body.position.x ) {
    score = score + 10
  }
}